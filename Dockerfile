...
# docker build -t therasaurus_rails .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name therasaurus_rails therasaurus_rails
...
RUN SECRET_KEY_BASE_DUMMY=1 \
    ...
    STRIPE_PRICE_YEARLY_ID=price_dummy_yearly \
